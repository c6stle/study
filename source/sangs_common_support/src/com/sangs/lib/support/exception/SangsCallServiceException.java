 ...
 * </pre>
 */
public class SangsCallServiceException extends RuntimeException {
 
	private static final long serialVersionUID = -8409380411572300202L;
	
	//private String messageCd;
	
	public SangsCallServiceException() {
		super();
	}

	public SangsCallServiceException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
		super(message, cause, enableSuppression, writableStackTrace);
	}
	public SangsCallServiceException(String message, Throwable cause) {
		super(message, cause);
	}
	public SangsCallServiceException(Throwable cause) {
		super(cause);
	}
	
	public SangsCallServiceException(String messageNm) {
		super(messageNm);
	}
