...
public class SangsResourceCloseHelper {
	/**
	 * Resource close 처리.
	 * @param resources Closeable
	 */
		...
		for (Closeable resource : resources) {
			if (resource != null) {
				try {
					...
					SangsBasicLogger.ignore("Occurred IOException to close resource is ingored!!");
				} catch (Exception ignore) {
					SangsBasicLogger.ignore("Occurred Exception to close resource is ingored!!");
				}
			}
		}
	}
			...
			if (object != null) {
				if (object instanceof ResultSet) {
					try {
						...
						SangsBasicLogger.ignore("Occurred SQLException to close resource is ingored!!");
					} catch (Exception ignore) {
						SangsBasicLogger.ignore("Occurred Exception to close resource is ingored!!");
					}
	...
	public static void closeSocketObjects(Socket socket, ServerSocket server) {
		if (socket != null) {
			try {
				...
				SangsBasicLogger.ignore("Occurred Exception to shutdown ouput is ignored!!");
			}
			...
			try {
				...
				SangsBasicLogger.ignore("Occurred Exception to close resource is ignored!!");
			}
		}
