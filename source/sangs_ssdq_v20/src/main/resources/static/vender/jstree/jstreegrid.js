		...
		this._initialize = function () {
			if (!this._initialized) {
				...
				if (!styled) {
					styled = true;
					styles = [
						'.jstree-grid-cell {vertical-align: top; overflow:hidden;margin-left:0;position:relative;width: 100%; white-space: nowrap;}',
						'.jstree-grid-cell span {margin-right:0px;margin-right:0px;*display:inline;*+display:inline;white-space: nowrap;}',
						'.jstree-grid-separator {position:relative; float:right;margin-left: -2px; border-width: 0 2px 0 0; *display:inline; *+display:inline; margin-right:0px;width:0px;}',
						...
						'.jstree-grid-header-regular {padding: 12px 0px; background-color: #5986c2; font-size: 13px; color: #fff; text-align: center; vertical-align: middle; font-weight: 500;}',
						'.jstree-grid-header-regular:first-child {border-radius: 5px 0 0 0;}',
						'.jstree-grid-header-regular:last-child {border-radius: 0 5px 0 0;}',
