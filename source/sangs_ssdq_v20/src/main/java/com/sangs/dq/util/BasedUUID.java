...
public class BasedUUID implements Serializable {
    /*
     ...
     * @param leastSigBits
     */
    public BasedUUID(long mostSigBits, long leastSigBits) {
     ...
     */
    public static BasedUUID randomUUID() {
        ...
        return new BasedUUID(randomBytes);
    }
     ...
     */
    public static BasedUUID fromString(String name) {
        ...
        return new BasedUUID(mostSigBits, leastSigBits);
    }
    ...
    public boolean equals(Object obj) {
    	...
    	if (!(obj instanceof BasedUUID))
            return false;
        if (((BasedUUID) obj).variant() != this.variant())
            return false;
        BasedUUID id = (BasedUUID) obj;
     ...
     */
    public int compareTo(BasedUUID val) {
