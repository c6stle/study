 ...
 * @see
 */
public class CollectorFileUploadUtil extends CollectorFormBasedFileUtil {
    /**
     * 파일을 Upload 처리한다.
     * @param request
     * @param where
     ...
     * @throws Exception
     */
    public static List<CollectorFormBasedFileVo> uploadFiles(HttpServletRequest request, String where) throws Exception {
     ...
     * @throws Exception
     */
    public static List<CollectorFormBasedFileVo> uploadImages(HttpServletRequest request, String where) throws Exception {
