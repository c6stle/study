...
public class CollectorFormBasedUUID implements Serializable {
    /*
     ...
     */
    private CollectorFormBasedUUID(byte[] data) {
        long msb = 0;
        long lsb = 0;
        for (int i = 0; i < 8; i++) {
     ...
     * @param leastSigBits
     */
    public CollectorFormBasedUUID(long mostSigBits, long leastSigBits) {
     ...
     */
    public static CollectorFormBasedUUID randomUUID() {
        ...
        return new CollectorFormBasedUUID(randomBytes);
    }
     ...
     */
    public static CollectorFormBasedUUID fromString(String name) {
        ...
        return new CollectorFormBasedUUID(mostSigBits, leastSigBits);
    }
    ...
    public boolean equals(Object obj) {
    	...
    	if (!(obj instanceof CollectorFormBasedUUID))
            return false;
        if (((CollectorFormBasedUUID) obj).variant() != this.variant())
            return false;
        CollectorFormBasedUUID id = (CollectorFormBasedUUID) obj;
     ...
     */
    public int compareTo(CollectorFormBasedUUID val) {
