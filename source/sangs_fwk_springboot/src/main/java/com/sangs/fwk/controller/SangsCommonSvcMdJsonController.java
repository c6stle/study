...
import com.sangs.fwk.common.CommonSvcMdServiceInvoker;
...
@SangsController("/sm_json")
public class SangsCommonSvcMdJsonController {
	
	@Autowired
	private CommonSvcMdServiceInvoker commonSvcMdServiceInvoker;
	...
	public Object dataMethod(Map<String, Object> paramMap, String serviceId, String methodId) throws Exception {
		...
		Object obj = commonSvcMdServiceInvoker.dataMethod(paramMap, serviceId, methodId);
